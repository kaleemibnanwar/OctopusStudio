...
(async () => {
  const browser = await electron.launch({
    args: [
      "../../out/octopusStudio-darwin-arm64/octopusStudio.app/Contents/Resources/app.asar/.vite/build/main.js",
      "--enable-logging",
      "--user-data-dir=/tmp/octopusStudio-e2e-tests",
    ],
    executablePath:
      "../../out/octopusStudio-darwin-arm64/octopusStudio.app/Contents/MacOS/octopusStudio",
  });
