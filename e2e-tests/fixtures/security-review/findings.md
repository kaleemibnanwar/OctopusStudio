...
<octopus-studio-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
<octopus-studio-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<octopus-studio-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<octopus-studio-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<octopus-studio-security-finding title="JWT Secret Using Default Value" level="high">
...
<octopus-studio-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<octopus-studio-security-finding title="Missing Security Headers" level="low">
