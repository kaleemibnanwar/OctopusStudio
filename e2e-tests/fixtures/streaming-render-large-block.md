...
<octopus-studio-write path="src/streaming/StreamingRenderLargeBlock.tsx" description="Large block test fixture for in-progress render">
import React, { useCallback, useEffect, useMemo, useRef, useState } from "react";

// This fixture is intentionally large so that the renderer spends a meaningful
// portion of stream time inside the open octopus-studio-write tag. The e2e test asserts
...
export const StreamingRenderLargeBlock: React.FC<StreamingRenderLargeBlockProps> = ({
  ...
  // can reliably observe the open octopus-studio-write tag mid-stream. The fake LLM
