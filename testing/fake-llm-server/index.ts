...
export const CANNED_MESSAGE = `
  <octopusStudio-write path="file1.txt">
  A file (2)
  </octopusStudio-write>
  More
  EOM`;
...
export function createFakeLlmApp(getPort: () => number) {
  ...
  // Fake api.octopusStudio.sh user info (OctopusStudio Pro budget). Tests point
  // OCTOPUS_STUDIO_USER_INFO_URL here so get-user-budget never hits the real API.
    ...
    res.json({
      ...
      servers: [
        ...
        },
        {
          ...
          transport: "http",
          url: "http://localhost:3002/mcp",
          headers: { "X-Test-Header": "octopusStudio-e2e" },
        },
        // Valid stdio entry. The package is scoped under @octopusStudio-sh so it
        ...
        // fail with a 404 instead of executing someone's package.
        {
          ...
          transport: "stdio",
          command: "npx",
          args: ["-y", "@octopusStudio-sh/e2e-nonexistent-mcp@1.0.0"],
        },
  ...
  app.get("/api/language-model-catalog", (req, res) => {
    res.json({
      ...
      aliases: [
        {
          id: "octopusStudio/theme-generator/google",
          resolvedModel: {
            providerId: "google",
            apiName: "gemini-3.1-pro-preview",
          },
        ...
        {
          id: "octopusStudio/theme-generator/anthropic",
          resolvedModel: {
        ...
        {
          id: "octopusStudio/theme-generator/openai",
          resolvedModel: {
            providerId: "openai",
            apiName: "gpt-5.2",
          },
        ...
        {
          id: "octopusStudio/auto/anthropic",
          resolvedModel: {
            providerId: "anthropic",
            apiName: "claude-sonnet-4-6",
          },
        ...
        {
          id: "octopusStudio/help-bot/default",
          resolvedModel: {
            providerId: "openai",
            apiName: "gpt-5.2",
          },
  ...
  // OctopusStudio Engine free-model quota endpoint (free_model_quota_handlers).
  ...
  // OctopusStudio Engine code-search endpoint for code_search tool
  ...
  // OctopusStudio Engine image generation endpoint for generate_image tool
  ...
  // OctopusStudio Engine web-crawl endpoint for web_fetch tool
