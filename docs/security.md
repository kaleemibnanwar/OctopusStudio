...
OctopusStudio uses MustardScript for local-agent attachment inspection. The tool is
...
- allows `.octopus-studio/` paths within the app (attachments, script output, etc.)
