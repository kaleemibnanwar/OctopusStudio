...
OctopusStudio will support multiple windows that can show and control the same chat or
...
have produced an external side effect, so OctopusStudio must not silently replay it
