...
/**
 * Incremental octopus-studio-tag parser.
 *
...
// Recognised octopus-studio custom-tag names. Anything outside this set with a
// leading "<NAME" is treated as markdown text, matching the rendering
// behavior in OctopusStudioMarkdownParser.
const OCTOPUS_STUDIO_CUSTOM_TAG_NAMES = [
  "octopus-studio-write",
  "octopus-studio-rename",
  "octopus-studio-delete",
  "octopus-studio-add-dependency",
  "octopus-studio-execute-sql",
  "octopus-studio-read-logs",
  "octopus-studio-add-integration",
  "octopus-studio-enable-nitro",
  "octopus-studio-output",
  "octopus-studio-problem-report",
  "octopus-studio-chat-summary",
  "octopus-studio-edit",
  "octopus-studio-grep",
  "octopus-studio-explore-code",
  "octopus-studio-search-replace",
  "octopus-studio-codebase-context",
  "octopus-studio-web-search-result",
  "octopus-studio-web-search",
  "octopus-studio-web-crawl",
  "octopus-studio-web-fetch",
  "octopus-studio-code-search-result",
  "octopus-studio-code-search",
  "octopus-studio-read",
  "octopus-studio-git",
  "think",
  "octopus-studio-command",
  "octopus-studio-mcp-tool-call",
  "octopus-studio-mcp-tool-result",
  "octopus-studio-mcp-tool-search",
  "octopus-studio-mcp-tool-schema",
  "octopus-studio-list-files",
  "octopus-studio-database-schema",
  "octopus-studio-db-table-schema",
  "octopus-studio-supabase-table-schema",
  "octopus-studio-supabase-project-info",
  "octopus-studio-neon-project-info",
  "octopus-studio-neon-table-schema",
  "octopus-studio-read-guide",
  "octopus-studio-status",
  "octopus-studio-compaction",
  "octopus-studio-copy",
  "octopus-studio-image-generation",
  "octopus-studio-image-search",
  "octopus-studio-write-plan",
  "octopus-studio-exit-plan",
  "octopus-studio-questionnaire",
  "octopus-studio-step-limit",
  "octopus-studio-script",
  "octopus-studio-app-blueprint",
  "octopus-studio-security-finding",
  "octopus-studio-test-assertions",
  ...
  "octopus-studio-generate-test",
  "octopus-studio-search-chats",
  "octopus-studio-read-chat",
  "octopus-studio-explore-chat-history",
];
const OCTOPUS_STUDIO_CUSTOM_TAG_SET = new Set(OCTOPUS_STUDIO_CUSTOM_TAG_NAMES);
...
export interface ParserState {
  ...
  cursor: number;
  mode: Mode;
  /** Bytes seen but not yet committed (e.g. partial "<octopus-studio-..."). */
  pending: string;
...
export function advanceParser(prev: ParserState, content: string): ParserState {
  ...
  while (i < len) {
    ...
    if (state.mode === "tag-open") {
      ...
      if (
        OCTOPUS_STUDIO_CUSTOM_TAG_SET.has(name) &&
        (ch === " " || ch === "\t" || ch === "\n" || ch === "\r" || ch === ">")
      ) {
