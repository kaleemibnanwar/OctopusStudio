...
// transitively by the chat message tree (OctopusStudioWrite -> FileEditor), so the hybrid
...
// OCTOPUS_STUDIO_SKIP_MANAGED_PNPM_INSTALL harness touchpoint.)
const IS_VITEST =
  typeof process !== "undefined" && process.env.VITEST === "true";

if (!IS_VITEST) {
  loader.init().then((monaco) => {
    monaco.editor.defineTheme("octopus-studio-light", customLight);
    monaco.editor.defineTheme("octopus-studio-dark", customDark);
