...
import { OctopusStudioTokenSavings } from "./OctopusStudioTokenSavings";

interface OctopusStudioThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const OctopusStudioThink: React.FC<OctopusStudioThinkProps> = ({
  children,
  node,
}) => {
  ...
  const tokenSavingsMatch =
    typeof children === "string"
      ? children.match(
          /^octopus-studio-token-savings\?original-tokens=([0-9.]+)&smart-context-tokens=([0-9.]+)$/,
        )
      : null;
  ...
  // If it's token savings format, render OctopusStudioTokenSavings component
