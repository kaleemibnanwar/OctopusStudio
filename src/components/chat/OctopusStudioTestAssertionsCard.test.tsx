...
describe("OctopusStudioTestAssertionsCard", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("resumes the parked turn instead of sending a chat message", async () => {
    ...
    screen.getByTestId("octopus-studio-test-assertions-approve-button").click();
  ...
  it("closing the card answers the parked turn with no spec", async () => {
    ...
    screen.getByTestId("octopus-studio-test-assertions-discard-button").click();
    ...
    await screen.findByTestId("octopus-studio-test-assertions-discarded-note");
  });
  ...
  it("leaves the plan approvable when the discard can't be recorded", async () => {
    ...
    expect(
      screen.queryByTestId("octopus-studio-test-assertions-discarded-note"),
    ).toBeNull();
  });
  ...
  it("hands the spec over as a new turn when nothing is waiting on the card", async () => {
    ...
    expect(
      screen.queryByTestId("octopus-studio-test-assertions-discard-button"),
    ).toBeNull();
    screen.getByTestId("octopus-studio-test-assertions-approve-button").click();
