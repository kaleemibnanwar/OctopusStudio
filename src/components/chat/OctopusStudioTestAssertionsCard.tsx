...
/**
 * The `<octopus-studio-test-assertions>` card: a reviewable plan of a recorded test's steps
...
interface OctopusStudioTestAssertionsCardProps {
  node: {
    properties: {
      "proposal-id"?: string;
      "request-id"?: string;
...
export const OctopusStudioTestAssertionsCard: React.FC<
  OctopusStudioTestAssertionsCardProps
> = ({ node, children }) => {
  ...
  const requestVerificationRun = (generatedSpecPath: string) => {
    ...
    streamMessage({
      prompt: [
        `I approved the assertions. Octopus Studio generated ${generatedSpecPath} from my recording.`,
        "",
  ...
  if (!payload) {
    ...
    return (
      <div
        ...
        data-testid="octopus-studio-test-assertions-card"
      >
      ...
      <div className="px-3.5 pt-2.5 pb-2">
        <div className="flex items-baseline gap-2">
          ...
          <span
            ...
            data-testid={
              isApproved && !isBusy
                ? "octopus-studio-test-assertions-approved-badge"
                : undefined
            }
          >
      ...
      <ol className="border-t border-border/50 py-2" role="list">
        {items.map((item, index) => {
          ...
          if (item.kind === "step") {
            return (
              <li
                ...
                data-testid={`octopus-studio-test-assertions-step-${item.stepIndex}`}
          ...
          return (
            <li
              key={item.id}
              data-testid={`octopus-studio-test-assertions-assertion-${item.id}`}
                ...
                <div className="min-w-0 flex-1">
                  {isEditing ? (
                    <textarea
                      ...
                      data-testid={`octopus-studio-test-assertions-edit-${item.id}`}
                    ...
                    <button
                      ...
                      data-testid={`octopus-studio-test-assertions-text-${item.id}`}
                      className={cn(
                ...
                {!isLocked && !isEditing && (
                  <>
                    ...
                    <button
                      ...
                      title="Remove"
                      data-testid={`octopus-studio-test-assertions-remove-${item.id}`}
                      className={cn(
                        ICON_BUTTON,
                        ROW_ACTION,
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-border/50 px-3.5 py-2.5">
        {isApproving ? (
          ...
          <span
            ...
            data-testid="octopus-studio-test-assertions-generating-note"
          >
          ...
          <span
            className="inline-flex items-center gap-1.5 text-xs text-muted-foreground"
            data-testid="octopus-studio-test-assertions-closing-note"
          >
            <Loader2 size={12} className="animate-spin motion-reduce:hidden" />
            Closing the plan…
          </span>
          ...
          <>
            ...
            <button
              ...
              disabled={!specPath}
              data-testid="octopus-studio-test-assertions-open-file-button"
          ...
          <span
            ...
            data-testid="octopus-studio-test-assertions-discarded-note"
          >
          ...
          <>
            <span className="text-xs text-muted-foreground">
              {hasBlankAssertion
                ...
                : isAgentWaiting
                  ? "Octopus Studio is waiting on this before it continues."
            ...
            {isAgentWaiting && (
              <button
                ...
                disabled={isBusy}
                data-testid="octopus-studio-test-assertions-discard-button"
            ...
            <button
              ...
              data-testid="octopus-studio-test-assertions-approve-button"
              className={cn(
