...
interface OctopusStudioWriteProps {
  children?: ReactNode;
  node?: any;
  path?: string;
  description?: string;
...
export const OctopusStudioWrite: React.FC<OctopusStudioWriteProps> = ({
  children,
  node,
  path: pathProp,
  ...
  return (
    ...
    >
      <OctopusStudioCardHeader icon={<Pencil size={15} />} accentColor="blue">
