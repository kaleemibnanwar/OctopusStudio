...
import { OctopusStudioBadge } from "./OctopusStudioCardPrimitives";

interface OctopusStudioReadProps {
  children?: ReactNode;
  node?: any;
  path?: string;
  startLine?: string;
...
export const OctopusStudioRead: React.FC<OctopusStudioReadProps> = ({
  children,
  node,
  path: pathProp,
