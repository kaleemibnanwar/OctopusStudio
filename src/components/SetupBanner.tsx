...
import { SetupOctopusStudioProButton } from "./ProBanner";
...
export function SetupBanner({
  ...
  const handleOctopusStudioProSetupClick = () => {
    posthog.capture("setup-flow:ai-provider-setup:octopusStudio:click");
    ipc.system.openExternalUrl(
      "https://academy.octopusStudio.sh/redirect-to-checkout?trialCode=7PRO30&utm_source=octopus-studio-app&utm_medium=app&utm_campaign=setup-dialog-v2",
    );
  };
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-2xl text-center">
          ...
          {variant === "dialog" && hasPendingPrompt && !hasProviderSetup ? (
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              {hasProviderSetup
                ? "Change how OctopusStudio accesses AI."
                : "OctopusStudio uses AI to build your app."}
            </p>
          )}
        </div>
        ...
        <button
          type="button"
          onClick={handleOctopusStudioProSetupClick}
        ...
        >
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-primary/10">
              <img src={logo} alt="OctopusStudio Logo" className="size-6" />
            </div>
            <div className="min-w-0">
              <h3 className="text-lg font-semibold text-primary">
                Start free OctopusStudio Pro trial
              </h3>
