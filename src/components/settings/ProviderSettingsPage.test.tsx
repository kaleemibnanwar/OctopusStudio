...
function validationError(message: string, kind: OctopusStudioErrorKind) {
...
describe("ProviderSettingsPage", () => {
  ...
  it("resumes an implicit first prompt with the new OctopusStudio Pro default", async () => {
    mocks.hasArmedPayload = true;
    mocks.validateProviderApiKey.mockResolvedValue(undefined);
    mocks.updateSettings.mockResolvedValue(undefined);

    renderProviderSettingsPage("auto");
    await saveApiKey("OctopusStudio", "auto");
  ...
  it.each([
    [
      ...
      "Google rate limited the API key check.",
    ],
    [
