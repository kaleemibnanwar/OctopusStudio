...
const AppCommandsTitle = () => (
  <div className="flex items-center gap-2">
    ...
    <Tooltip>
      ...
      <TooltipContent>
        <p>
          Configure custom install and start commands for your app, plus an
          optional preview URL for non-Node backends.
          <br />
...
const AppCommandsSection = ({
  ...
  const updateCommandsMutation = useMutation({
    mutationFn: async ({
      ...
      return await ipc.app.updateAppCommands({
        ...
        previewUrl: previewUrlValue.trim() || null,
      });
    },
    onSuccess: () => {
  ...
  }, [installCommand, startCommand, previewUrl, updateCommandsMutation]);
  ...
  const hasPreviewUrl = !!app?.previewUrl;
  const hasCustomConfig = hasCustomCommands || hasPreviewUrl;
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="http://127.0.0.1:10202"
                value={previewUrl}
                onChange={(e) => setPreviewUrl(e.target.value)}
              />
              <p className="text-xs text-muted-foreground">
                Use for non-Node backends (e.g. Django, Flask). Overrides the
                auto-detected dev-server URL.
              </p>
            </div>
            {!commandsValid && (
            ...
            <div className="p-3 border rounded-md bg-muted/30">
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p
                    data-testid="current-preview-url"
                    className="font-mono text-sm truncate"
                  >
                    {app.previewUrl || "—"}
                  </p>
