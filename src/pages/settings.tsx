...
import { ImageSearchSettings } from "@/components/settings/ImageSearchSettings";
      ...
      <div className="mx-auto max-w-5xl px-6 py-8 md:px-10">
        ...
        <div>
          ...
          <SettingsSection
            ...
            description="Connect the AI providers Octopus Studio uses to build and run your apps."
          >
          ...
          <SettingsSection
            ...
            title="Telemetry"
            description="Anonymous usage data that helps improve Octopus Studio."
          >
          ...
          <SettingsSection
            ...
            title="Integrations"
            description="Link Octopus Studio to the services you deploy and store data with."
          >
            ...
            <div id={SETTING_IDS.imageSearch}>
              <ImageSearchSettings />
            </div>
          </SettingsSection>
...
export function GeneralSettings({ appVersion }: { appVersion: string | null }) {
  ...
  return (
    <SettingsSection
      ...
      title="General"
      description="Appearance, language, and how Octopus Studio runs on your machine."
    >
...
export function WorkflowSettings() {
  return (
    <SettingsSection
      ...
      title="Workflow"
      description="How Octopus Studio handles code changes, previews, and notifications."
    >
...
export function AISettings() {
  return (
    ...
    >
      <div id={SETTING_IDS.defaultModel}>
        <DefaultModelSetting />
      </div>
