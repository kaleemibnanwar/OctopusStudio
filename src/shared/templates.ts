...
export const localTemplatesData: Template[] = [
  DEFAULT_TEMPLATE,
  {
    ...
    githubUrl: "https://github.com/octopus-studio-sh/nextjs-template",
    isOfficial: true,
  },
  {
    id: "react-vite-nitro",
    ...
    imageUrl:
      "https://github.com/user-attachments/assets/5b700eab-b28c-498e-96de-8649b14c16d9",
    githubUrl: "https://github.com/octopus-studio-sh/react-vite-nitro",
    isOfficial: true,
    isExperimental: true,
  },
  {
    ...
    githubUrl:
      "https://github.com/octopus-studio-sh/portal-mini-store-template",
    isOfficial: true,
    isExperimental: true,
    requiresNeon: true,
  },
