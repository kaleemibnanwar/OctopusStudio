...
export async function setupHybridChatHarness(
  ...
  try {
    ...
    (
      globalThis as HybridBridgeDiagnosticGlobal
    ).__OCTOPUS_STUDIO_HYBRID_BRIDGE__ = bridge;
    ...
    const dispose = async (): Promise<void> => {
      ...
      try {
        ...
        if (diagnosticGlobal.__OCTOPUS_STUDIO_HYBRID_BRIDGE__ === bridge) {
          delete diagnosticGlobal.__OCTOPUS_STUDIO_HYBRID_BRIDGE__;
        }
