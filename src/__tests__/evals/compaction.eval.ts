 ...
 *
 * Run:
 *   OCTOPUS_STUDIO_PRO_API_KEY=... EVAL_SUITE/EVAL_MODEL not used — this suite is
...
if (
  !process.env.OCTOPUS_STUDIO_PRO_API_KEY &&
...
const canRun = hasOctopusStudioProKey() && fixtures.length > 0 && optedIn;
