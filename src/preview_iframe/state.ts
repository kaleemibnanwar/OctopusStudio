 ...
 *
 * "octopus-studio" — the user chose it through OctopusStudio's chrome (address bar, back/forward,
 ...
 */
export type PreviewRouteSource = "none" | "octopus-studio" | "app";
...
export interface PreviewError {
  ...
  readonly source: "preview-app" | "octopus-studio-app" | "octopus-studio-sync";
}
...
export type PreviewIframeEvent =
  ...
  | {
       ...
       * shim, so without it the preview keeps reporting the route OctopusStudio last
  ...
  | {
      type: "IFRAME_ERROR";
      message: string;
      source: "preview-app" | "octopus-studio-app";
    }
...
export type PreviewIframePostMessage =
  ...
  | { type: "activate-octopus-studio-component-selector" }
  | { type: "deactivate-octopus-studio-component-selector" }
