...
import { chatProjectContracts } from "../types/chat_project";
...
export const VALID_INVOKE_CHANNELS = [
  ...
  ...getInvokeChannels(taskContracts),
  ...getInvokeChannels(workerContracts),
  ...getInvokeChannels(chatProjectContracts),
