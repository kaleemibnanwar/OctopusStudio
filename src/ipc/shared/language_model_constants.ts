...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  auto: [
    ...
    },
    {
      ...
      description:
        "5 free messages per day for OctopusStudio Pro users (note: your data may be used for training models)",
      tag: "Free",
      tagColor: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
...
> = {
  ...
  vertex: {
    ...
    // Use the same gateway prefix as Google Gemini for OctopusStudio Pro compatibility.
    gatewayPrefix: "gemini/",
    secondary: true,
  },
  openrouter: {
  ...
  auto: {
    displayName: "OctopusStudio",
    websiteUrl: "https://academy.octopusStudio.sh/subscription",
