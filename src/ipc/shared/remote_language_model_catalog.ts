...
function getRemoteLanguageModelCatalogUrl() {
  if (process.env.OCTOPUS_STUDIO_LANGUAGE_MODEL_CATALOG_URL) {
    return process.env.OCTOPUS_STUDIO_LANGUAGE_MODEL_CATALOG_URL;
  }
  ...
  return "https://api.octopusStudio.sh/v1/language-model-catalog";
}
...
const KNOWN_BUILTIN_MODEL_ALIASES = [
  "octopusStudio/theme-generator/google",
  "octopusStudio/theme-generator/anthropic",
  "octopusStudio/theme-generator/openai",
  "octopusStudio/auto/openai",
  "octopusStudio/auto/anthropic",
  "octopusStudio/auto/google",
  "octopusStudio/auto/openrouter",
  "octopusStudio/help-bot/default",
] as const;
...
const DEFAULT_THEME_GENERATION_OPTIONS: ThemeGenerationModelOption[] = [
  { id: "octopusStudio/theme-generator/google", label: "Google" },
  { id: "octopusStudio/theme-generator/anthropic", label: "Anthropic" },
  { id: "octopusStudio/theme-generator/openai", label: "OpenAI" },
];
...
function buildFallbackCatalog(): BuiltinLanguageModelCatalog {
  ...
  return {
    ...
    aliases: [
      ...
      {
        id: "octopusStudio/auto/openrouter",
        resolvedModel: {
