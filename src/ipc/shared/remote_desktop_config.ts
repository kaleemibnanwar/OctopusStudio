...
function getRemoteDesktopConfigUrl() {
  if (process.env.OCTOPUS_STUDIO_DESKTOP_CONFIG_URL) {
    return process.env.OCTOPUS_STUDIO_DESKTOP_CONFIG_URL;
  }

  return "https://api.octopusStudio.sh/v1/desktop-config";
}
