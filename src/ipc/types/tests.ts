...
/**
 * The app-relative directory where OctopusStudio keeps a user app's Playwright E2E
...
/**
 * The directory OctopusStudio used for E2E specs before `E2E_TEST_DIR`. Existing apps may
