...
const DebugSystemInfoSchema = z.object({
  /** OctopusStudio application version (from package.json) */
  octopusStudioVersion: z.string(),
...
const DebugSettingsSchema = z.object({
  ...
  /** Whether OctopusStudio Pro is enabled */
  enableOctopusStudioPro: z.boolean().nullable(),
