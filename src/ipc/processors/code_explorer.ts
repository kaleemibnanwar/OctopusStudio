...
export function toCodeExplorerError(error: unknown): Error {
  ...
  if (
    ...
    return new OctopusStudioError(message, OctopusStudioErrorKind.Precondition);
  }
  ...
  if (
    ...
    return new OctopusStudioError(message, OctopusStudioErrorKind.Validation);
  }
...
function keyUnavailableError(): OctopusStudioError {
...
function getHost(): CodeExplorerHost {
  ...
  const child = utilityProcess.fork(workerPath, [], {
    serviceName: "octopus-studio-code-explorer",
