...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a OctopusStudio app to a Supabase project.
  ...
  // Unset app project - removes the link between a OctopusStudio app and a Supabase
    ...
    createAppOperationHandler(
      ...
      async (_, { appId }) => {
        ...
        try {
          ...
          if (isOctopusStudioError(classified)) {
            throw classified;
          }
          ...
          // exception (`rules/octopus-studio-errors.md`).
          throw new OctopusStudioError(
  ...
  testOnlyHandle(
    ...
    async (
      ...
      // octopusStudio://supabase-oauth-return deep link would.
