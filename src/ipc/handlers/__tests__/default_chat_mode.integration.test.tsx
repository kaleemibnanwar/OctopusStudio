...
const OCTOPUS_STUDIO_PRO_SETTINGS: Partial<UserSettings> = {
...
describe("default chat mode selector (integration)", () => {
  ...
  beforeAll(async () => {
    harness = await setupHybridChatHarness({
      ...
      // OctopusStudio Pro settings trigger free-quota fetches; route them to the fake
      // engine instead of the real engine.octopusStudio.sh.
      engine: true,
      settings: { isTestMode: true, ...OCTOPUS_STUDIO_PRO_SETTINGS },
    });
  }, 60_000);
