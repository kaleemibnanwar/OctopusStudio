...
| ---------------------------------------------------------------------- | ------: | -------: | ------------------------------------------- |
| [#4100](https://github.com/octopus-studio-sh/octopus-studio/pull/4100) |      14 |       14 | construction, reentry, disposal, retention  |
| [#4105](https://github.com/octopus-studio-sh/octopus-studio/pull/4105) |       9 |       10 | authorization, dedupe, subscriptions        |
| [#4108](https://github.com/octopus-studio-sh/octopus-studio/pull/4108) |      14 |       31 | request/runtime identity, waiters, deletion |
| [#4116](https://github.com/octopus-studio-sh/octopus-studio/pull/4116) |       5 |       11 | claims, routing, reset                      |
| [#4121](https://github.com/octopus-studio-sh/octopus-studio/pull/4121) |      10 |       19 | effects, UI admission, deletion, retention  |
| [#4119](https://github.com/octopus-studio-sh/octopus-studio/pull/4119) |      50 |       96 | queue ownership, settlement, finalization   |
| [#4123](https://github.com/octopus-studio-sh/octopus-studio/pull/4123) |      16 |       35 | persistence, Git recovery, window interest  |
...
- Expected authorization denial returns
  `{ kind: "deny", error: OctopusStudioError }`.
...
Expected denial remains a `OctopusStudioError` with its original `OctopusStudioErrorKind`
...
- Preserve `OctopusStudioErrorKind`; do not hide dependency/programming failures as
  denial.
