...
useStreamChat, OctopusStudioMarkdownParser, chat_stream/commands.ts). Update the
...
1. isStreamActive-family selectors over StreamState; migrate useStreamChat
   ...
   PromoMessage, OctopusStudioOutput, OctopusStudioMarkdownParser). Every hook read uses
