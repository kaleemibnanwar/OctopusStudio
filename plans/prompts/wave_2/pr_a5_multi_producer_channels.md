...
octopus-studio-app-sourced cloud-sandbox errors) and the release-age-over-
...
1. previewError channel → preview_iframe-owned state ({message, source}
   ...
   updater semantics (octopus-studio-sync must not clobber preview-app/octopus-studio-app;
